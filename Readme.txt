...
Command to run: 
	...
	type : python decisionTree.py "train_data_set" "test_data_set" "attribute_mapping_file"
	It will print the tree with accuracy in training set as well as test data set
	Output file will be generated containing predicted class_value with its correctness
